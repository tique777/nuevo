...
class PortafolioWeb:
    ...
    def build_inicio(self):
        return ft.ResponsiveRow([
            ft.Column([
                ...
                ft.ElevatedButton("Ver servicios", bgcolor=self.color_primaria, color="white",
                                  on_click=lambda _: self.cambiar_pagina(1)),

                ft.ElevatedButton("Ver resumen", bgcolor=self.color_primaria, color="white",
                                  on_click=lambda _: self.cambiar_pagina(2)),
                ...
                ft.Text("📧 Correo: davidsantiagot49@gmail@gmail.com", color="white", size=16),
                ft.Text("📱 Celular: 311 2606511", color="white", size=16),
    ...
    def build_resumen(self):
        return ft.Column([
            ...
            ft.ElevatedButton("Ver servicios", bgcolor=self.color_primaria, color="white",
                              on_click=lambda _: self.cambiar_pagina(1)),
            ft.ElevatedButton("Ver inicio", bgcolor=self.color_primaria, color="white",
                              on_click=lambda _: self.cambiar_pagina(0))
        ], spacing=20)
